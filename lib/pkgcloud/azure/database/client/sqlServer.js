...
// The Create Server Firewall Rule operation updates an existing server-level
...
// ### @callback {'startIpAddress'} starting IP address of the rule.
// ### @callback {'endIpAddress'} ending IP address of the rule.
...
//
// ### @options {Object} Set of options can be
// #### options['id'] {String} id of the SQL server (required)
// #### options['ruleName'] {String} name to assign to the new firewall rule.
// ### @callback {Object} result object containing the following properties
// #### result['ipAddress'] {String} the IP address detected by IP autodetect.
// #### result['ruleName'] {String} name assigned to the new firewall rule.
// #### result['statusCode'] {int} resultCode of request. Should be 200.
...
// The listServerFirewallRules method retrieves a list of all the server-level
...
// The deleteFirewallRule method deletes a server-level firewall
